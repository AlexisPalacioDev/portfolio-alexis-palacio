...
export const I18N = {
  en: {
    ...
    soft_agile: 'Agile / Scrum',
    soft_comm: 'Communication',
    soft_review: 'Code Review',
    ...
    ask_chip_1: 'What is my tech stack?',
    ask_chip_2: 'Tell me about my experience',
    ask_chip_3: 'What kind of role am I looking for?',
    ...
    ask_no_context: 'I don\'t have information about that in my verified profile. Please contact me at alexis26-93@live.com for details.',
  ...
  es: {
    ...
    soft_agile: 'Ágil / Scrum',
    soft_comm: 'Comunicación',
    soft_review: 'Code Review',
    soft_remote: 'Trabajo Remoto',
    soft_decisions: 'Decisiones',
    ...
    ask_chip_1: '¿Cuál es mi stack tecnológico?',
    ask_chip_2: 'Cuéntame de mi experiencia',
    ask_chip_3: '¿Qué tipo de rol busco?',
    ...
    ask_no_context: 'No tengo información sobre eso en el perfil verificado. Por favor contáctame en alexis26-93@live.com para más detalles.',
