...
export const I18N = {
  en: {
    ...
    ask_chip_1: 'What is Alexis\'s tech stack?',
    ask_chip_2: 'What has he built with AI?',
  ...
  es: {
    ...
    ask_chip_1: '¿Con qué tecnologías trabaja Alexis?',
    ask_chip_2: '¿Qué ha construido con IA?',
    ...
    ask_no_context: 'No tengo información sobre eso en mi perfil verificado. Por favor contáctame en alexis26-93@live.com para más detalles.',
